...
let favoriteFoods = ['Prime Rib', 'Baked Potato', 'Caesar Salad', 'Hazy IPA']
...
lastAnimal = animalArray[numberOfAnimals-1];
console.log('The last animal is', lastAnimal);
...
let entree = 'Spinach & Artichoke Dip';
favoriteFoods.unshift(entree);
console.log(`Added an Appitizer to beginning: ${favoriteFoods}`);
...
for(let index of gems){
  colorfulGems.push(index);
}
